...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    // 2 note auto
    return AutoFactories.driveToPos(driveSys,new Translation2d(2.2,5.5)).onlyIf(()->driveSys.getPosition().getTranslation().getDistance(new Translation2d(2,5.5))>0.5).andThen(AutoFactories.speaker(driveSys, arm, shooter))

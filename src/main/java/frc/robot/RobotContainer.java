...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    }/*,Rotation2d.fromRotations(0.5)*/).alongWith(Intake.fromFloor(shooter,arm,secondController.getHID()))).andThen(new SpeakerShoot(driveSys,arm,rt2::setCustomRotation,shooter, secondController.getHID()).raceWith(rt2.repeatedly()));
  }
}

...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    var rt2=new RotateTo(driveSys,new Rotation2d());
    ...
    }/*,Rotation2d.fromRotations(0.5)*/).alongWith(Intake.fromFloor(shooter,arm,secondController.getHID()))).andThen(new SpeakerShoot(driveSys,arm,rt2::setCustomRotation,shooter, secondController.getHID()).alongWith(rt2.andThen(Commands.print("784dsjuery7huadslye7irdushyaei67sduh*\n784dsjuery7huadslye7irdushyaei67sduh*\n784dsjuery7huadslye7irdushyaei67sduh*\n784dsjuery7huadslye7irdushyaei67sduh*\n784dsjuery7huadslye7irdushyaei67sduh*\n784dsjuery7huadslye7irdushyaei67sduh*\n"))));
  }
}

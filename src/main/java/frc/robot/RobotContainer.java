...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.addOption("Escape the confines of the white tape!!!!", Commands.defer(()->AutoFactories.driveToPos(driveSys,new Pose2d(driveSys.getPosition().getTranslation(),FieldConstants.flip(new Rotation2d())).plus(new Transform2d(2,0,Rotation2d.fromDegrees(0))).getTranslation()), Set.of(driveSys)));

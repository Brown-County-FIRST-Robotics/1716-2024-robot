...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // Amp scoring\
    secondController.povRight().whileTrue(Commands.runOnce(()->teleopDrive.setCustomRotation(Optional.of(Rotation2d.fromDegrees(90)))).andThen(AutoFactories.driveToPos(driveSys,    new Pose2d(2,7.75,Rotation2d.fromDegrees(90)))));

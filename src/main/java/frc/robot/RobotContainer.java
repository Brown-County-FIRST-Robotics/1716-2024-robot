...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    return new SpeakerShoot(driveSys,arm,rt::setCustomRotation,shooter, secondController.getHID()).alongWith(rt).andThen(new HolonomicTrajectoryFollower(driveSys,()->{

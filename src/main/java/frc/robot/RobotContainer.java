...
public class RobotContainer {
  ...
  private TeleopDrive configureSharedBindings() {
    ...
    secondController.start().onTrue(Commands.run(()->teleopDrive.isKidMode=!teleopDrive.isKidMode));
    secondController.povUp().onTrue(Commands.run(()->teleopDrive.kidModeSpeed+=0.5));
    secondController.povDown().onTrue(Commands.run(()->teleopDrive.kidModeSpeed-=0.5));

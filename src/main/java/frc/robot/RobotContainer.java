    ...
    secondController
        ...
        .whileTrue(
            new RotateTo(driveSys, Rotation2d.fromDegrees(90))
                .andThen(new HolonomicTrajectoryFollower(driveSys,()-> AutoFactories.makeTrajectory(driveSys,new Pose2d(FieldConstants.getAmp(), Rotation2d.fromDegrees(90))),Rotation2d.fromDegrees(90)).until(()->{return driveSys.getPosition().getTranslation().getDistance(FieldConstants.getAmp())<0.075&&Math.abs(driveSys.getPosition().getRotation().minus(Rotation2d.fromDegrees(90)).getDegrees())<5;}))
                .raceWith(

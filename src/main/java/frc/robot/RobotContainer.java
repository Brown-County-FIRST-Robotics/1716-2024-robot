...
public class RobotContainer {
  ...
  private void configureDemoBindings() {
    ...
    secondController.povUpRight().and(secondController.y()).onTrue(new ScheduleCommand(new TeleopDrive(driveSys,driverController,2)));
    secondController.rightTrigger().onTrue(driveSys.run(()->driveSys.humanDrive(new ChassisSpeeds())).until(secondController.povLeft()));
  }

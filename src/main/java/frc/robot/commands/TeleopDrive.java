...
public class TeleopDrive extends CommandBase {
  ...
  public void execute() {
    ...
    Translation2d spsd =
        powerWeight(dedeadband(new Translation2d(controller.getLeftY(), controller.getLeftX())), 2);
...
System.out.printf("stickvel %f %f %s", controller.getLeftX(), controller.getLeftX(), vel);
      locked = false;

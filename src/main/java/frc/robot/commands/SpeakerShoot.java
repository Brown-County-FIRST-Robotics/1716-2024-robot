...
public class SpeakerShoot extends Command {
  ...
  public void execute() {
    ...
    var botAngle=botPose.minus(FieldConstants.getSpeaker()).toTranslation2d().getAngle();
    var shooterAngle=new Rotation2d(botPose.minus(FieldConstants.getSpeaker()).toTranslation2d().getNorm(),botPose.minus(FieldConstants.getSpeaker()).getZ());

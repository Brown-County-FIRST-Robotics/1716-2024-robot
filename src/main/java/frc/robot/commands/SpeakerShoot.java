...
public class SpeakerShoot extends Command {
  ...
  public void execute() {
    ...
    Translation3d botPose = new Translation3d(pos.getX(),pos.getY(),0.5);//new Pose3d(pos.getX(), pos.getY(), 0,new Rotation3d()).transformBy(new Transform3d(new Translation3d(0.3,0,0.3),new Rotation3d(0,-arm.getAngle().getRadians(),0))).transformBy(new Transform3d(new Translation3d(0.3,0,0.18),new Rotation3d())).getTranslation();

...
//            .transformBy(new Transform3d(new Translation3d(0.3,0,0.18),new Rotation3d())).getTranslation();
    Translation3d botPose=new Pose3d(pos.getX(),pos.getY(),0.65,new Rotation3d(0,0,pos.getRotation().getRadians())).transformBy(new Transform3d(0.4,0,0,new Rotation3d())).getTranslation();

...
public class FeederIODCSpark implements FeederIO {
  ...
  LoggedTunableNumber p = new LoggedTunableNumber("Shooter/feed_p", 1);
  LoggedTunableNumber i = new LoggedTunableNumber("Shooter/feed_i", 0);
  LoggedTunableNumber d = new LoggedTunableNumber("Shooter/feed_d", 0);

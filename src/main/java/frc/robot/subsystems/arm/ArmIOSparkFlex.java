...
public class ArmIOSparkFlex implements ArmIO {
  ...
  LoggedTunableNumber offset=new LoggedTunableNumber("Arm/offset",0.7);
  ...
  public ArmIOSparkFlex(int id) {
    ...
    pid.setSmartMotionMaxVelocity(0.7*FREE_RPM / GEAR_RATIO, 0);
    pid.setSmartMotionMinOutputVelocity(0, 0);
    pid.setSmartMotionMaxAccel(100, 0);
    pid.setSmartMotionAllowedClosedLoopError(0.05, 0);

...
public class ModuleIOSparkFX implements ModuleIO {
  ...
  LoggedTunableNumber steerP = new LoggedTunableNumber("Steer P", 0.0 / STEER_FREE_RPM);
  ...
  LoggedTunableNumber steerKV =
      new LoggedTunableNumber("Steer KV", 2*STEER_GEAR_RATIO / STEER_FREE_RPM);
  ...
  public ModuleIOSparkFX(int thrustID, int steerID, String name) {
    ...
    pid.setSmartMotionMaxAccel(1*STEER_FREE_RPM / STEER_GEAR_RATIO, 0);

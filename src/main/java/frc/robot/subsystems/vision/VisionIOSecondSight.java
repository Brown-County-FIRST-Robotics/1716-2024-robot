  ...
  public VisionIOSecondSight(String name) {
    ...
    idsSub =
        table
            ...
            .subscribe(
                new String[] {}, PubSubOption.keepDuplicates(true), PubSubOption.sendAll(true),PubSubOption.pollStorage(3));
    posesSub =
        table
            .getDoubleArrayTopic("Pose")
            .subscribe(
                new double[] {}, PubSubOption.keepDuplicates(true), PubSubOption.sendAll(true),PubSubOption.pollStorage(3));
    errorSub =
        table
            .getDoubleTopic("RMSError")
            .subscribe(-1, PubSubOption.keepDuplicates(true), PubSubOption.sendAll(true),PubSubOption.pollStorage(3));
  }
